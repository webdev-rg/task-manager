...
export const SideMenu = ({ activeMenu }) => {
  ...
  return (
    <div className="w-72 md:w-64 bg-white border-r border-gray-200/50 sticky top-[61px] z-50 transition-all duration-300 ease-in-out" style={{height: "calc(100vh - 61px)"}}>
